...
### Fixed
- Bump version for republish to PyPI after environment policy update.
- Keep CI/CD pipeline current with manual dispatch support and scoped security scanning.
